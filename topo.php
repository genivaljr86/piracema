  		<div id="faixa">
        	<div class="centraliza">
	            ...
	            <div id="menu_d">
	            	<a href=""><img src="<?php servidor(); ?>images/menu_top/4_off.png" alt="" class="botao <?php echo $guia[4]; ?>"></a>
	            	<a href=""><img src="<?php servidor(); ?>images/menu_top/5_off.png" alt="" class="botao <?php echo $guia[5]; ?>"></a>
	            	<a href=""><img src="<?php servidor(); ?>images/menu_top/6_off.png" alt="" class="botao <?php echo $guia[6]; ?>"></a>
	            </div>
